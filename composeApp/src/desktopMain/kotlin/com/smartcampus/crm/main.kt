...
fun main() {
    ...
    application {
        ...
        LaunchedEffect(Unit) {
            sessionManager.onForceLogout.collect {
                isLoggedIn = false
            }
        }

        SmartCampusTheme(isDarkTheme = isDarkTheme ?: isSystemInDarkTheme()) {
            Window(
                ...
                LaunchedEffect(window.graphicsConfiguration) {
                    ...
                    if (graphicsConfig != null) {
                        ...
                        val newWidth =
                            mainScreenBounds.width - screenInsets.left - screenInsets.right
                        val newHeight =
                            mainScreenBounds.height - screenInsets.top - screenInsets.bottom
